...
{
    class Find_the_Duplicate_Number2 : Testable
    {
        /*
        ...
        public Find_the_Duplicate_Number2()
        {
            testcases.Add(new InOut(5, 2, 3));
            testcases.Add(new InOut(25, 8, 4));
            testcases.Add(new InOut(15, 3, 5));
