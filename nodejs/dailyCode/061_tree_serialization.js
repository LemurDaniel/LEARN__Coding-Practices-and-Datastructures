...
Inout.push({
    ...
    serialized: '&isSplit=:&isNull=#&isLeaf=$&tree=1:3:$2:$5:4:#:$7',
    deserialized: '&RF input.tree'
});


Inout.solvers = [serializing];
Inout.solve();
...
function serializing(tree, isSplit, isNull, isLeaf) {

    const serialized = tree.serialize(isSplit, isNull, isLeaf)
