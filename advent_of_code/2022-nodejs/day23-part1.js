...
// NOTE:
//  node .\day23-part1.js [INPUT|TEST]
//
//  Enter:
//    'node .\day23-part1.js INPUT'    to process Todays input from 'day23-input.txt'.
//
//  Enter:
//    'node .\day23-part1.js TEST'     to process Todays Testinput from 'day23-input-test.txt'.
//    'node .\day23-part1.js'          to process Todays Testinput from 'day23-input-test.txt'.
...
class Elf extends Vector2D {
  ...
  static goOneRound() {
    ...
    // Need to be sperate loops, since all Elfs need to have decied, before check for move is possible.
    Elf.All.forEach(elf => elf.decideProposedMove())

    for (const elf of Object.values(Elf.Proposals)) {
...
console.log('\n///////////////////////////////////////////////////////////////\n')
console.group()
console.log(`After ${Elf.Rounds} Rounds there are '${solution.toLocaleString()}' free tiles in the rectangle.`)
console.log()
console.groupEnd()