...
// NOTE:
//  node .\day24-part2.js [INPUT|TEST]
//
//  Enter:
//    'node .\day24-part2.js INPUT'    to process Todays input from 'day24-input.txt'.
//
//  Enter:
//    'node .\day24-part2.js TEST'     to process Todays Testinput from 'day24-input-test.txt'.
//    'node .\day24-part2.js'          to process Todays Testinput from 'day24-input-test.txt'.
...
// Same as part 1 just function and redefining entry and exit. Timeoffset to get the correct blizzard states after forth and back.
function shortestPath(blizzard, entry, exit, timeoffset) {
  ...
  entry = new Node(entry.x, entry.y, 0)
  ...
  while (!queue.isEmpty) {
    ...
    if (node.is(exit)) return node


    // Consider one time ahead of where the Blizzard will be.
    const nextBlizzard = blizzard.getTime(node.steps + 1 + timeoffset)
    ...
    for (const direction of directions) {
      ...
      // else enqueue positions in queue
      queue.enqueue(next)
    }
...
const [entry, exit] = [blizzard.entry, blizzard.exit]

// Call Function for all three trips and apply time of previous trips for blizzad time offset.
const trip1ToExit = shortestPath(blizzard, entry, exit, 0)
console.log(trip1ToExit, trip1ToExit.steps)
const trip2ToEntry = shortestPath(blizzard, exit, entry, trip1ToExit.steps)
console.log(trip2ToEntry, trip2ToEntry.steps)
const trip3ToExit = shortestPath(blizzard, entry, exit, trip1ToExit.steps + trip2ToEntry.steps)
console.log(trip3ToExit, trip3ToExit.steps)

///////////////////////////////////////////////////////////////

// Add all three trips together
const solution = trip1ToExit.steps + trip2ToEntry.steps + trip3ToExit.steps
console.clear()
console.log('\n///////////////////////////////////////////////////////////////\n')
console.group()
