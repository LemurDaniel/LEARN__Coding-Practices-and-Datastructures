...
<p>Your puzzle answer was <code>2=020-===0-1===2=020</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>The <span title="You notice an engraving on the equipment: Balanced Quinary Industries.">hot air balloons</span> quickly carry you to the North Pole. As soon as you land, most of the expedition is escorted directly to a small building attached to the reindeer stables.</p>
...
<p>If you still want to see it, you can <a href="https://adventofcode.com/2022/day/25/input" target="_blank">get your puzzle input</a>.</p>
