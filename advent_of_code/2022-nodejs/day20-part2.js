...
// NOTE:
//  node .\day20-part2.js [INPUT|TEST]
//
//  Enter:
//    'node .\day20-part2.js INPUT'    to process Todays input from 'day20-input.txt'.
//
//  Enter:
//    'node .\day20-part2.js TEST'     to process Todays Testinput from 'day20-input-test.txt'.
//    'node .\day20-part2.js'          to process Todays Testinput from 'day20-input-test.txt'.
...
const references = Input.map(num => list.insert(num * DecryptionKey))

// Shift nodes several rounds while maintaining original order.
for (let i = 0; i < RemixingRounds; i++) {
