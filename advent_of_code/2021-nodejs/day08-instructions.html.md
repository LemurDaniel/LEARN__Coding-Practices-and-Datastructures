...
<div id="sidebar">
<div id="sponsor"><div class="quiet">Our <a href="https://adventofcode.com/2021/sponsors">sponsors</a> help make Advent of Code possible:</div><div class="sponsor"><a href="https://sectorlabs.ro" target="_blank" onclick="if(ga)ga('send','event','sponsor','sidebar',this.href);" rel="noopener">SECTOR LABS</a> - We do large classifieds websites. Hiring Py3/React in the EU.</div></div>
</div><!--/sidebar-->
...
<p>Your puzzle answer was <code>548</code>.</p><p class="day-success">The first half of this puzzle is complete! It provides one gold star: *</p>
...
<p>Although it hasn't changed, you can still <a href="https://adventofcode.com/2021/day/8/input" target="_blank">get your puzzle input</a>.</p>
